...
<body class="relative min-h-screen
    ...
    <div class="flex flex-col justify-center items-center gap-6 w-full">
        ...
        <form action="" class="flex bg-[#f5f0ed] z-10 flex-col items-center px-10 py-10 w-[90%] sm:w-1/2 lg:w-1/3 shadow-lg gap-4 rounded-lg">
            ...
            <button class="bg-[#CC774A] hover:shadow-md px-5 py-2 text-white rounded-md mt-2 cursor-pointer">Submit</button>
